...
BOOST_FUSION_DEFINE_STRUCT ((shared_class), PlayerNameAndCards, (std::string, name) (std::vector<std::optional<durak::Card> >, cards))
BOOST_FUSION_DEFINE_STRUCT ((shared_class), DurakWaitingForEndOfRoundAnimation, (bool, defendTakesCardsFromTable) (std::vector<shared_class::PlayerNameAndCards>, playerNameAndCardsToDraw))
